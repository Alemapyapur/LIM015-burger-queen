...
>
> **Importante:** 
> Nuestros clientes, pueden cambiar su pedido las veces que deseen antes de finalizarlo. 


La interfaz muestra los dos menús (desayuno y resto del día), cada uno
con todos sus _productos_. El usuario podra ir eligiendo qué _productos_
...
![img](src/img/inicio-bur.PNG)
![img](src/img/pedido-bur.PNG)
![img](src/img/prototipo.9.PNG)
...
Así que esta experiencia espera familiarizarnos con el concepto de _estado de pantalla_,
